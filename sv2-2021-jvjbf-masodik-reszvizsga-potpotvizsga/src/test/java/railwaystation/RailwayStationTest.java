...
class RailwayStationTest {
    ...
    @Test
    void testInit() {
        assertEquals(9, railwayStation.getTrainsAtStation().size());
    }
    ...
    void testAddTrain() {
        ...
        assertEquals(10, railwayStation.getTrainsAtStation().size());
    }
    ...
    void testGetLongestTrain() {
        ...
        assertEquals(35, expected.getWagons());
    ...
    void testGetTrainsWithPassengersMoreThan() {
        ...
        assertEquals(9, expected.get(0).getWagons());
        assertEquals("Erkel Ferenc Intercity", expected.get(1).getName());
        assertEquals(10, expected.get(1).getWagons());
    }
}